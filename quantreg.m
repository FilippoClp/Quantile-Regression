...
options = optimset('MaxFunEvals',100000,'MaxIter',100000); %added by F. Claps for reproducibility purpose
...
if nargout>1
    ...
    rng('default') %added by F. Claps for reproducibility purpose
